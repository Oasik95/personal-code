...
<body>
	<h2 align="center">MANGE TRAIN TRIP</h2>
...
?>
	...
	<form action="addCheck.php" method="post" enctype="">
	...
	<form action="delettrin.php" method="post" enctype="">
		...
		<form action="Updatetrain.php" method="post" enctype="">
