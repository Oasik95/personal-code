...
<body>
	<h2 align="center">MANGE PLANE TRIP</h2>
...
?>
	...
	<form action="addplane.php" method="post" enctype="">
	...
	<form action="deletplane.php" method="post" enctype="">
		...
		<form action="updateplane.php" method="post" enctype="">
